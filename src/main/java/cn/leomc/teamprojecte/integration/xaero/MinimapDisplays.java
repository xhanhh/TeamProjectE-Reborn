package cn.leomc.teamprojecte.integration.xaero;
...
public class MinimapDisplays {
    ...
    static {
        ...
        PE_EMC_INFO_BUILDER = builder
                .setId("teamprojecte_pe_emc")
                .setName(Component.translatable("xaerominimap.teamprojecte.infodisplay.pe_emc"))
                ...
                .setCompiler((displayInfo, compiler, session, availableWidth, playerPos) -> {
                    ...
                    if (TPMixinPlugin.CONFIG == null || !TPMixinPlugin.CONFIG.isEnableXaeroMinimapEMCDisplay()) {
                        return;
                    }
                    if (mc.player == null) {
                        return;
                    ...
                    boolean showFull = TPMixinPlugin.CONFIG.isEnableXaeroMinimapEMCDisplayHoldShiftShowFull() && Screen.hasShiftDown();
                    ...
                    if (TPMixinPlugin.CONFIG.isEnableXaeroMinimapEMCDisplayRate()) {
