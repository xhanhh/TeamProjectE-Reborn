...
public final class TPConfig {
    ...
    static File config = new File(FMLUtils.getConfigDir().toFile(), "teamprojecte-common.json");

    @SneakyThrows
    public static TPConfig loadConfig() {

        TPConfig defaultConfig = new TPConfig();
        ...
        TPConfig loaded = gson.fromJson(json, TPConfig.class);
        if (loaded == null) {
    ...
    @SneakyThrows
    public static void write(TPConfig cakeConfig) {
